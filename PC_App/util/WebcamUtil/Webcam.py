...
class Webcam():
    def __init__(self, webcam_num:int=0):
    ...
    #Class for Facial Pose Estimation through Webcam
        ...
        while self.streaming:
            ...
            if ret == True:
                ...
                for face in faces:
                    ...
                    (success, rotation_vector, translation_vector) = cv2.solvePnP(self.model_points, image_points, camera_matrix, dist_coeffs, flags=cv2.SOLVEPNP_UPNP)
                    # save in self.latest_position
